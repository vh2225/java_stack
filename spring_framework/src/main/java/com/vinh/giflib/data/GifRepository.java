...
public class GifRepository {
    private static final List<Gif> ALL_GIFS = Arrays.asList(
        ...
        new Gif("cowboy-coder", 5, LocalDate.of(2015,2,13), "Grace Hopper", false),
        new Gif("infinite-andrew", 6, LocalDate.of(2015,8,23), "Marissa Mayer", true)
    );
