...
import com.vinh.spark.model.CourseIdea;
import com.vinh.spark.model.CourseIdeaDAO;
import com.vinh.spark.model.NotFoundException;
import com.vinh.spark.model.SimpleCourseIdeaDAO;
    ...
    public static void main(String[] args) {
        ...
        before("/ideas", (req, res) -> {
            if (req.attribute("username") == null){
                setFlashMessage(req,"Wooah! please sign in first!");
                res.redirect("/");
                halt();
            }
        });
